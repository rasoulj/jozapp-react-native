...
import {primary} from "../../jozdan-common-temp";
...
import {OrderTypes} from "../../jozdan-common-temp";
...
export function ServiceButton({image, title, onPress, backgroundColor = primary}) {
